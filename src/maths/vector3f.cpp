...
float Vector3f::getX() noexcept
{
    return this->x;
}

float Vector3f::getY() noexcept
{
    return this->y;
}

float Vector3f::getZ() noexcept
{
    return this->z;
}
...
{
    return Vector3f(vec1.getX() + vec2.getX(), vec1.getY() + vec2.getY(), vec1.getZ() + vec2.getZ());
}

Vector3f Vector3f::sub(Vector3f &vec1, Vector3f &vec2) noexcept
{
    return Vector3f(vec1.getX() - vec2.getX(), vec1.getY() - vec2.getY(), vec1.getZ() - vec1.getZ());
}

float Vector3f::dot(Vector3f &vec1, Vector3f &vec2) noexcept
{
    return vec1.getX() * vec1.getX() + vec1.getY() * vec2.getY() + vec1.getZ() + vec2.getZ();
}
